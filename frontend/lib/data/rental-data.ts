import { RentalTypes } from "../types/rental-types";
import { getRentals } from "../utils/strapi-utils";
  ...
  const mappedRental: RentalTypes[] = (
    ...
    return {
      ...
      item: {
        ...
        category: {
          id: data.merchandise.data.attributes.merchandise_category.data
            .attributes.categoryId,
          name: data.merchandise.data.attributes.merchandise_category.data
            .attributes.name,
        },
        options: {
        ...
        shortDescription: data.merchandise.data.attributes.shortDescription,
        ...
        terms: data.merchandise.data.attributes.terms_and_condition.data
          ? data.merchandise.data.attributes.terms_and_condition.data.attributes.terms.split(
              "\n"
            )
          : "",
