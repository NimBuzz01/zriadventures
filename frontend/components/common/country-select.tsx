...
const CountrySelect = ({
    ...
    return (
        <div className={className}>
            ...
            <Select defaultValue={value.toString()} onValueChange={onChange}>
                <SelectTrigger
                    className={`${
                ...
                <SelectContent className="z-[1002] h-96">
                    <SelectGroup>
                        <SelectItem value="Afghanistan">Afghanistan</SelectItem>
                        <SelectItem value="Aland Islands">
                            Aland Islands
                        </SelectItem>
                        ...
                        <SelectItem value="Congo, Democratic Republic of the Congo">
                            Congo, Democratic Republic of the Congo
                        </SelectItem>
                        <SelectItem value="Cook Islands">
                            Cook Islands
                        </SelectItem>
                        ...
                        <SelectItem value="Faroe Islands">
                            Faroe Islands
                        </SelectItem>
                        ...
                        <SelectItem value="Saint Barthelemy">
                            Saint Barthelemy
                        </SelectItem>
                        <SelectItem value="Saint Helena">
                            Saint Helena
                        </SelectItem>
                        ...
                        <SelectItem value="Serbia and Montenegro">
