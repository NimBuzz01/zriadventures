...
const Payment = ({ setCurrentStep, currentStep }: Props) => {
  ...
  const handlePaymentAmountChange = (
    ...
    const selectedAmount = e.target.value as "ADVANCE" | "FULL" | "INSTALLMENT";
      ...
      if (paymentMethod === "PAYHERE") {
        if (paymentAmount === "FULL") {
          ...
          editPaymentStatus({
            ...paymentStatus,
            total: parseFloat((tempTotal * 1.03).toFixed(2)),
            payAmount: parseFloat(((tempTotal * 1.03) / 4).toFixed(2)),
          });
        }
      } else if (paymentMethod === "KOKO" || paymentMethod === "MINTPAY") {
        editPaymentStatus({
          ...paymentStatus,
        ...
        <li>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="w-full font-medium">Bank Transfer</div>
            </div>
          </label>
        </li>
      </ul>
            ...
            <li>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="w-full font-medium">Credit / Debit Card</div>
                </div>
              </label>
            </li>
            <li>
              ...
              >
                <div className="flex items-center">
                  <div className="w-full font-medium">Pay with Koko</div>
            ...
            <li>
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="w-full font-medium">Pay with MintPay</div>
                  <div className="relative h-6 w-24">
                    <BlurImage
            ...
            <ul className="grid w-full gap-4">
                    ...
                    <div className="flex flex-col gap-2 py-2">
                      ...
                      <p className="text-3xl font-medium text-gray-600">
                        {paymentStatus.currency === "LKR" ? (
                          <>LKR {((tempTotal * 1.03) / 4).toFixed(2)}</>
                        ) : (
                          <>USD ${((tempTotal * 1.03) / 4).toFixed(2)}</>
                        )}
                      </p>
                      <p className="text-sm text-gray-400">
                        You will pay 25% off your total booking value now and
                        balance can be paid on the day of your experience. 3%
              ...
              <li>
                ...
                >
                  <div className="flex flex-col gap-2 py-2">
                    ...
                    <p className="text-3xl font-medium text-gray-600">
                      {paymentStatus.currency === "LKR" ? (
                        <>LKR {(tempTotal * 1.03).toFixed(2)}</>
                      ) : (
                        <>USD ${(tempTotal * 1.03).toFixed(2)}</>
                      )}
                    </p>
                    <p className="text-sm text-gray-400">
                      You will pay the full amount of your booking now and no
                      further payments. 3% Convenience fee is added
                    </p>
                  </div>
                </label>
              </li>
              {isVoucherAdded && (
                <li className="border-2 border-red-500 bg-red-100 p-5 text-center text-sm sm:text-base">
                  ...
                  <span className="font-medium"> voucher</span> has been applied
                  to your order.
                </li>
              )}
            </ul>
          ...
          {paymentMethod === "KOKO" && (
            <ul className="grid w-full gap-4">
              <li>
                ...
                >
                  <div className="flex flex-col gap-2 py-2">
                    <p className="w-full font-medium">Pay in Installments</p>
                    <p className="text-3xl font-medium text-gray-600">
                      {paymentStatus.currency === "LKR" ? (
                        <>LKR {(paymentStatus.payAmount / 3).toFixed(2)}</>
                      ) : (
                        <>USD ${(paymentStatus.payAmount / 3).toFixed(2)}</>
                      )}{" "}
                      <span className="text-2xl text-gray-500">x 3</span>
                    </p>
                    <p className="text-sm text-gray-400">
                      You will pay in 3 installments for the relevant merchants.
        ...
        <div>
          <ul className="grid w-full gap-4">
              ...
              <li>
                ...
                >
                  <div className="flex flex-col gap-2 py-2">
                    ...
                    <p className="text-3xl font-medium text-gray-600">
                      {paymentStatus.currency === "LKR" ? (
                        <>LKR {(tempTotal / 4).toFixed(2)}</>
                      ) : (
                        <>USD ${(tempTotal / 4).toFixed(2)}</>
                      )}
                    </p>
                    <p className="text-sm text-gray-400">
                      You will pay 25% off your total booking value now and
                      balance can be paid on the day of your experience
                    </p>
                  </div>
                </label>
              </li>
            ...
            <li className="text-sm italic text-gray-400">
              The bank details for the payment will be sent according to the
              bank transfer currency selected.
            </li>
          </ul>
        </div>
      )}
