...
import ZRIProcess from "./zri-process";
...
const About = () => {
  return (
    <main>
      ...
      <SubHero title={ABOUT_HERO_MAIN_TITLE} image={ABOUT_HERO_BG_IMAGE} />
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="relative flex w-full max-w-[1000px] flex-wrap items-center justify-between gap-10 px-10 pb-4 sm:w-[90%] sm:py-16 sm:pb-16">
          <div className="flex flex-col gap-1">
            ...
            <p className="font-medium uppercase text-md text-blue-950 sm:text-xl">
              {ABOUT_LOCATIONS_TEXT}
            </p>
          </div>
          <div className="flex flex-col gap-1">
