...
import ThumbnailCarousel from '@/components/carousels/thumbnail-carousel'
...
const MerchandiseContent = ({ merchandiseId }: { merchandiseId: string }) => {
    ...
    const merch =
        merchandise &&
        merchandise.find(
            (merch: MerchandiseTypes) => merch.id === merchandiseId
        )
