            ...
            <div className="flex flex-col flex-grow p-5">
                <div className="flex flex-col justify-between w-full lg:flex-row">
                    ...
                    <p className="text-lg font-medium md:text-xl">
                        {Boolean(item.item.experience.offer) && (
                            <span className="p-1 mr-2 text-sm bg-green-200 rounded-md">
                                {item.item.experience.offer}% Off
                            </span>
                        )}
                        {local ? (
                            <>
                ...
                <div className="flex flex-col w-full md:flex-row">
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="flex flex-col mb-2">
                            ...
                            <span className="flex items-center gap-2 text-">
                                ...
                                {formatDate(
                                    item.item.date.toString().split('T')[0]
                                )}{' '}
                    ...
                    <div className="w-full md:w-1/2">
                        <div className="flex flex-col mb-2">
                            ...
                            <span className="flex items-center gap-2 text-">
                                <IoManSharp /> {item.item.adults} Pax
                            </span>
                        </div>
                        <div className="flex flex-col mb-2">
                            <p className="text-xs text-gray-500 uppercase">
                            ...
                            <span className="flex items-center gap-2 text-">
                                <FaChild /> {item.item.children} Pax
                            </span>
                        </div>
                    </div>
                </div>
                {item.item.experience.bundle && (
                    <div className="mt-4">
                        <p className="text-xs text-gray-500 uppercase">
                            Bundle
                        </p>
                        <ul className="ml-6 list-disc">
                            {item.item.experience.category
                                .filter(
                                    (category) =>
                                        ![
                                            'water-activities',
                ...
                {item.item.extras.length > 0 && (
                    <div className="mt-4">
                        ...
                        {item.item.extras.map((item, index) => (
