...
import { calculateExperienceTotal, generateVoucherCode } from '@/lib/utils'
            ...
            item: {
                ...
                voucher: {
                    ...
                    voucherTemplate: {
                        ...
                        alt:
                            selectedVoucher.voucherTemplate + ' Template Image',
                    },
                },
            },
            itemType: 'VOUCHER',
            ...
            <div className="flex w-full flex-col gap-10 p-4 lg:flex-row lg:gap-16">
                ...
                <div className="flex w-full flex-grow flex-col lg:w-1/2">
                        ...
                        <p className="mb-4 flex justify-between font-medium text-gray-800">
                            ...
                            <span className="font-normal">
                                {local ? (
                                    <>
                                        LKR{' '}
                                        {selectedVoucher.cashAmount?.toFixed(2)}
                                        /-
                                    </>
                                ) : (
                                    <>
                    ...
                    <ul className="ml-4 mt-auto list-disc text-sm text-gray-400">
                        ...
                        <li>
                            The voucher can be used as a full or part payment
                            for any activity or experience
                        </li>
                        <li>
                            The voucher is valid 6 months from the purchase
                            date. (if it is amount voucher)
                        </li>
                        <li>
                            The voucher is valid 3 months from the purchase
                            date. (if it is experience voucher)
                        </li>
                    </ul>
                </div>
            </div>
