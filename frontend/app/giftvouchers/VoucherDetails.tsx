...
const VoucherDetails = ({ setCurrentStep, currentStep }: Props) => {
  ...
  const validateInputs = () => {
    let isValid = true;
    if (voucher.giftTo === "Someone" && voucher.recipientName.trim() === "") {
    ...
    if (voucher.giftTo === "Someone" && voucher.recipientEmail.trim() === "") {
  ...
  return (
    <>
          ...
          <form action="#" className="flex flex-col gap-3">
              ...
              <li>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="w-full font-medium">For Someone Else</div>
                  </div>
                </label>
              </li>
              <li>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="w-full font-medium">For Yourself</div>
                  </div>
                </label>
              </li>
            </ul>
              ...
              <>
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      voucherActions.setRecipientName(e.target.value);
                    }}
                  />
                  {recipientNameError && (
                ...
                <div className="relative">
                  ...
                  <div
                    className={`pointer-events-none absolute inset-y-0 left-0 top-6 flex items-center pl-3.5 ${
                      recipientEmailError && `top-[0.4rem]`
                    }`}
                  >
                    <BiSolidUserCircle className="h-5 w-5 text-gray-500" />
                  </div>
                  <input
                    ...
                    onChange={(e) => {
                      voucherActions.setRecipientEmail(e.target.value);
                    }}
                  />
                  {recipientEmailError && (
                    <span className="mt-1 text-xs text-red-500">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                onChange={(e) => {
                  voucherActions.setPersonalMessage(e.target.value);
                }}
              />
        ...
        <div className="w-full lg:w-1/2">
            ...
            <li>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="w-full font-medium">Gift Cash Voucher</div>
                </div>
              </label>
            </li>
            <li>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="w-full font-medium">Gift an Experience</div>
                </div>
              </label>
            </li>
          </ul>
          {voucher.voucherType === "Cash" ? (
            <>
                  ...
                  ? [
                      ...
                      >
                        <input
                          ...
                          value={price}
                          className="sr-only"
                          checked={voucher.cashAmount === price}
                          onChange={(e) => {
                        ...
                        />
                        {local ? <>LKR {price}/-</> : <>USD ${price}</>}
                      </label>
                    ))
                  : [10, 15, 20, 25, 30, 35, 40, 45].map((price) => (
                      <label
                        key={price}
                        className={`flex w-32 items-center justify-center rounded-md border border-gray-300 py-3 font-medium tracking-wide ${
                          voucher.cashAmount === price
              ...
              <div className="flex items-center gap-4">
                ...
                <input
                  ...
                  onChange={(e) => {
                    voucherActions.setCashAmount(parseInt(e.target.value));
                  }}
                />
                {amountError && (
            ...
            <>
              ...
              <p className="mb-2 font-medium">Select an Experience</p>
                ...
                {showSearchSuggestions && (
                  <ul className="absolute z-10 mt-2 w-full rounded-lg border border-gray-300 bg-white py-1 shadow-lg">
                    {experiences
                      ...
                      .map((experience: ExperienceTypes) => (
                        <li
                          key={experience.id}
                          className={`cursor-pointer px-4 py-2 hover:bg-gray-100 ${
                            voucher.selectedExperience?.item.experience.id ===
                            experience.id
              ...
              {experiences.filter((experience) =>
                ...
                <div className="mt-4">
                  <p className="mb-2 font-medium">Recommended Experiences</p>
                  {experiences
                    .filter((experience) =>
                      experience.suitedVoucher.some(
                        (suited) => suited.id === voucher.voucherId
                    ...
                    .map((filteredExperience) => (
                      <div
                        ...
                        onClick={() => {
                          handleExperienceSelect(filteredExperience);
                        }}
                      >
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <Card className="flex w-full items-center gap-2 p-3">
                      <div className="relative h-12 w-12 rounded-full">
                        <BlurImage
                          src={selectedExperience.images[0].src}
                          alt={selectedExperience.images[0].alt}
                          objectFit="cover"
                          style="rounded-full"
                        />
                      </div>
                      ...
                      {!voucher.selectedExperience ? (
                        <div
                          ...
                          onClick={() => {
                            ...
                            router.push("#reservation-voucher");
                          }}
                        >
                          Configure
                        </div>
      ...
      {showConfigure &&
        ...
        !voucher.selectedExperience &&
        !success && (
          <Reservation experience={selectedExperience} addType="gift" />
        )}
    </>
  );
};
