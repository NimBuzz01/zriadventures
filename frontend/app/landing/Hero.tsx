...
const Hero = () => {
    ...
    return (
        <div className="relative flex items-center justify-center h-screen overflow-hidden bg-center bg-cover bg-black/50 backdrop-blur">
            ...
            >
                <BsMouse className="text-4xl animate-bounce" />
