                ...
                {rental.options.map((option, index) => (
                  ...
                  >
                    <input
                      ...
                      checked={selectedOption?.duration === option.duration}
                  ...
                  >
                    ...
                    <div className="mt-10 text-gray-500">
                      ...
                      <p className="font-medium">
                        We will contact you via email or call on your inquiry.
                      </p>
                      <p className="mb-4 text-sm">
                        We don&#39;t allow direct purchases on our rental items.
