  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const formattedCategories = mappedCategories.map((category) => ({
          value: category.id,
          label: category.name,
        }));
    ...
    <Card className="mt-20">
      <div className="rounded-lg border border-gray-200 bg-white p-4">
        ...
        <div className="mt-4 flex items-center gap-4">
          ...
          />
          <label htmlFor="showOffers" className="block text-sm font-medium">
            Show Offers
          </label>
        </div>
        <div className="mt-4 flex items-center gap-4">
          ...
          />
          <label htmlFor="showBundles" className="block text-sm font-medium">
            Show Bundles
          </label>
        </div>
